          ...
          <Row>
            <Col>
              <h1>
                ...
                <a className="text-light" href="http://ganleumi.online">
                  ganleumi.online
                </a>
              </h1>
        ...
        <Navbar className="bg-teva-lime">
          <Nav className="mx-auto justify-content-center">
            <Nav.Link
              href=""
              className="px-4"
              onClick={() => this.changeTab("parks")}
              active={this.state.activeTab === "parks"}
            >
              שמורות טבע
            </Nav.Link>
            <Nav.Link
              href=""
              className="px-4"
              onClick={() => this.changeTab("campsites")}
              active={this.state.activeTab === "campsites"}
            >
              <span>חניוני לילה</span>
              <span role="img" aria-label="New" className="mr-1">
                🆕
              </span>
            </Nav.Link>
